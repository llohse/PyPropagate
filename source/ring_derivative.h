...
template <unsigned axis,class A,class R> 
void ring_derivative(const A &array,R & result,typename A::Scalar s){
...
template <unsigned axis,class A>
typename A::Copy ring_derivative(const A &array,typename A::Scalar s){
